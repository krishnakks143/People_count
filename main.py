...
if __name__ == "__main__":
    ip_cam_address = "http://192.168.1.2:8080/video"  # input("Enter the address of the IP Camera: ")
    alert_recipient = "hamzaaziz822@gmail.com"  # input("Enter email address of alert recipient: ")
